...
2. Right-click it and select "Extract Here" or "Extract All." Follow the prompts to extract the contents.
...
1. After the installation is complete, you can start the application by running:
   ```bash
   npm start
   ```
2. Open your web browser and go to `http://localhost:4200` to view the application in action.
